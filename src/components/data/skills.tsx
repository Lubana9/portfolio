...
export const SkillsData = [
  {
    name: "React",
    icon: <i className="devicon-react-original colored skill--icon"></i>,
  },
  {
    name: "JavaScript",
    icon: <i className="devicon-javascript-plain colored skill--icon"></i>,
  },
  {
    name: "TypeScript",
    icon: <i className="devicon-typescript-plain colored skill--icon"></i>,
  },
  {
    name: "MobX",
    icon: (
  ...
  {
    name: "HTML",
    icon: <i className="devicon-html5-plain colored skill--icon"></i>,
  },
  {
    name: "CSS",
    icon: <i className="devicon-css3-plain colored skill--icon"></i>,
  },
  {
    name: "SASS",
